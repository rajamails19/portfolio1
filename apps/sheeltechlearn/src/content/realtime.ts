...
export const realtimeSection: Section = {
  ...
  tagline: "What actually breaks live on-stage — and how to recover without missing a beat.",
  emoji: "◉",
  gradient: "from-[oklch(0.9_0.09_45)] via-[oklch(0.9_0.09_355)] to-[oklch(0.92_0.09_320)]",
  items: [
    {
      id: "list-of-10k",
