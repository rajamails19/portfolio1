...
export const projectsSection: Section = {
  slug: "projects",
  title: "Projects",
  tagline: "Portfolio-worthy builds — the story, the stack, the standing ovation.",
  emoji: "✧",
  gradient: "from-[oklch(0.9_0.09_320)] via-[oklch(0.92_0.09_350)] to-[oklch(0.92_0.09_20)]",
  items: [
    {
      id: "ai-notes-app",
