  ...
  items: [
    {
      ...
      answer: [
        ...
        { type: "heading", content: "The render → commit pipeline" },
        {
          ...
          nodes: [
            { label: "setState()", sub: "Trigger", tone: "coral" },
            { label: "Render", sub: "Build new VDOM", tone: "rose" },
            { label: "Reconcile", sub: "Diff old vs new", tone: "rose" },
    ...
    },
    {
      ...
      answer: [
        ...
        },
        {
          ...
          nodes: [
            { label: "Render", sub: "Pure computation", tone: "rose" },
            { label: "DOM Mutation", sub: "React writes DOM", tone: "rose" },
            { label: "useLayoutEffect", sub: "Sync — before paint", tone: "coral" },
    ...
    },
    {
      ...
      answer: [
        ...
        },
        {
          ...
          direction: "vertical",
          nodes: [
            { label: "New render", sub: "todos.map(...)", tone: "rose" },
