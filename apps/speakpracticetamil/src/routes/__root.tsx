...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A cinematic language acquisition platform built on listening, repetition and speaking. Enter the world of Aura." },
      { name: "author", content: "Aura" },
      { property: "og:title", content: "Aura — Speak the world before you read it" },
